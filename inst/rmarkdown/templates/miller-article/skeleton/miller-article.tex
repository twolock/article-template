...
\usepackage[left=1.5in,top=1.5in,right=1.5in,bottom=1.5in]{geometry}
...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Timothy M. Wolock (Imperial College London)},
             pdfkeywords = {HIV/AIDS, epidmiology, Bayesian statistics},  
